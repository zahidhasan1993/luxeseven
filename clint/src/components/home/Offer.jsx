  ...
  return (
    <div className="w-full bg-white text-black">
      ...
      <div className="mx-auto py-10 px-4 w-full max-w-7xl grid grid-cols-2">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-semibold font-agbalumo">
            Why Choose Us?
          </h2>
          <p className="text-sm">
            We are one of the biggest hotel chain in south asia. With a tag of
            seven star hotel. We offer many things for our customers.
          </p>
        </div>
        ...
        >
          ...
          <div className="col-span-full sm:col-span-2 md:col-span-1 lg:col-span-full w-full flex flex-col lg:flex-row">
            ...
            <div className="lg:ml-4 mx-auto max-w-sm inline-flex flex-col text-center lg:text-left">
              ...
              {/* Description */}
              <dd className="mt-2 text-sm">
                For those are traveling and enjoying with buddys we have their
                back.
              </dd>
            </div>
          </div>
